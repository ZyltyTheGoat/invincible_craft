...
import net.mcreator.invincible_craft.procedures.DisplayAtomicRayProcedure;
import net.mcreator.invincible_craft.procedures.AtomEveAbilityOverlayDisplayOverlayIngameProcedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class AtomEveAbilityOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (AtomEveAbilityOverlayDisplayOverlayIngameProcedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_atomic_bubble.png"), 4, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_air_density.png"), 37, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_atomic_blast.png"), 70, 4, 0, 0, 32, 32, 32, 32);

			if (DisplayAtomicRayProcedure.execute(entity)) {
				event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_atomic_ray.png"), 70, 4, 0, 0, 32, 32, 32, 32);
			}
			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_spike_clamp.png"), 103, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_atom_eve_construction.png"), 136, 4, 0, 0, 32, 32, 32, 32);
			...
			if (DoesHaveCDAbility5Procedure.execute(entity))
				event.getGuiGraphics().drawString(Minecraft.getInstance().font,
						...
						ReturnValueCooldown5Procedure.execute(entity), 145, 15, -65536, false);
		}
