...
import net.mcreator.invincible_craft.procedures.BattleBeastAbilityOverlayDisplayOverlayInGameProcedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class BattleBeastAbilityOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (BattleBeastAbilityOverlayDisplayOverlayInGameProcedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_battle_beast_leap.png"), 4, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_battle_beast_blood_hunt.png"), 37, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_battle_beast_uppercut_downslam.png"), 70, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_battle_beast_roar.png"), 103, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_battle_beast_bite.png"), 136, 4, 0, 0, 32, 32, 32, 32);
