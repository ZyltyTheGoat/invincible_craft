...
import net.mcreator.invincible_craft.procedures.ViltrumiteAbilityOverlayDisplayOverlayIngameProcedure;
...
import net.mcreator.invincible_craft.procedures.DisplayHeadCrushProcedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class ViltrumiteAbilityOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (ViltrumiteAbilityOverlayDisplayOverlayIngameProcedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_viltrumite_punch.png"), 4, 4, 0, 0, 32, 32, 32, 32);

			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_viltrumite_chop.png"), 37, 4, 0, 0, 32, 32, 32, 32);
			...
			event.getGuiGraphics().blit(new ResourceLocation("invincible_craft:textures/screens/ability_viltrumite_sonic_clap.png"), 136, 4, 0, 0, 32, 32, 32, 32);
