...
public class ExchangeCloneRenderer extends HumanoidMobRenderer<ExchangeCloneEntity, HumanoidModel<ExchangeCloneEntity>> {
	...
	private final HumanoidModel<ExchangeCloneEntity> slimModel;
	private final HumanoidModel<ExchangeCloneEntity> defaultModel;

	public ExchangeCloneRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public ResourceLocation getTextureLocation(ExchangeCloneEntity entity) {
	...
	@Override
	public void render(ExchangeCloneEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
		if (entity.isTame() && entity.getOwnerUUID() != null) {
			UUID ownerUUID = entity.getOwnerUUID();
	...
	private HumanoidModel<ExchangeCloneEntity> getModel(UUID uuid) {
