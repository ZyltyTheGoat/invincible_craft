...
import net.mcreator.invincible_craft.entity.model.ConquestModel;
...
public class ConquestRenderer extends GeoEntityRenderer<ConquestEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ConquestEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
