...
public class ModelViltrumiteMale<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("invincible_craft", "model_viltrumite_male"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = bone.addOrReplaceChild("Head2", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-3.2F, -4.0F, -4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.15F)).texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, -24.0F, 0.0F));
		...
		PartDefinition BodyLayer_r1 = Body2.addOrReplaceChild("BodyLayer_r1", CubeListBuilder.create().texOffs(50, 57).addBox(-3.5F, -0.0436F, -0.001F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, -2.2F, -0.1309F, 0.0F, 0.0F));
		PartDefinition BodyLayer_r2 = Body2.addOrReplaceChild("BodyLayer_r2", CubeListBuilder.create().texOffs(50, 57).mirror().addBox(-3.5F, -0.0436F, -0.001F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftArm2 = bone.addOrReplaceChild("LeftArm2", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(40, 32).mirror()
				.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(5.0F, -22.0F, 0.0F));
		...
		PartDefinition LeftLeg2 = bone.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 32).mirror()
