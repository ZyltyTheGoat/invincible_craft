...
import net.mcreator.invincible_craft.procedures.FlyOnKeyPressedProcedure;
...
public class FlyMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InvincibleCraftMod.addNetworkMessage(FlyMessage.class, FlyMessage::buffer, FlyMessage::new, FlyMessage::handler);
	}
}
