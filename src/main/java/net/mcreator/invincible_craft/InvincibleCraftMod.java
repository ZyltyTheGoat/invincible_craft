...
import net.mcreator.invincible_craft.init.InvincibleCraftModTabs;
import net.mcreator.invincible_craft.init.InvincibleCraftModSounds;
import net.mcreator.invincible_craft.init.InvincibleCraftModParticleTypes;
import net.mcreator.invincible_craft.init.InvincibleCraftModMobEffects;
import net.mcreator.invincible_craft.init.InvincibleCraftModMenus;
...
import net.mcreator.invincible_craft.init.InvincibleCraftModBlocks;
...
@Mod("invincible_craft")
public class InvincibleCraftMod {
	public static final Logger LOGGER = LogManager.getLogger(InvincibleCraftMod.class);
	public static final String MODID = "invincible_craft";

	public InvincibleCraftMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		InvincibleCraftModSounds.REGISTRY.register(bus);
		InvincibleCraftModBlocks.REGISTRY.register(bus);

		InvincibleCraftModItems.REGISTRY.register(bus);
		InvincibleCraftModEntities.REGISTRY.register(bus);

		InvincibleCraftModTabs.REGISTRY.register(bus);

		InvincibleCraftModMobEffects.REGISTRY.register(bus);

		InvincibleCraftModParticleTypes.REGISTRY.register(bus);

		InvincibleCraftModMenus.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									InvincibleCraftMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			InvincibleCraftMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
