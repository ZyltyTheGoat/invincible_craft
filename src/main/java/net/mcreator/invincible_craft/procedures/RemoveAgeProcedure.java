...
public class RemoveAgeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if ((((new Object() {
			...
			}.getEntity()).getCapability(InvincibleCraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new InvincibleCraftModVariables.PlayerVariables())).stat_strength - DoubleArgumentType.getDouble(arguments, "value") * 2 < 0) {
				{
					double _setval = 0;
					(new Object() {
						public Entity getEntity() {
			...
			}.getEntity()).getCapability(InvincibleCraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new InvincibleCraftModVariables.PlayerVariables())).stat_speed - DoubleArgumentType.getDouble(arguments, "value") * 2 < 0) {
				{
					double _setval = 0;
					(new Object() {
						public Entity getEntity() {
			...
			}.getEntity()).getCapability(InvincibleCraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new InvincibleCraftModVariables.PlayerVariables())).stat_vitality - DoubleArgumentType.getDouble(arguments, "value") * 2 < 0) {
				{
					double _setval = 0;
					(new Object() {
						public Entity getEntity() {
			...
			}.getEntity()).getCapability(InvincibleCraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new InvincibleCraftModVariables.PlayerVariables())).stat_intelligence - DoubleArgumentType.getDouble(arguments, "value") * 2 < 0) {
				{
					double _setval = 0;
					(new Object() {
						public Entity getEntity() {
		...
		if ((new Object() {
			...
			_player.displayClientMessage(Component.literal("Aged Down!"), true);
