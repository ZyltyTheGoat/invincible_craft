...
public class ArtRosenbaumCraftDupliKateSuitProcedure {
	public static void execute(Entity entity) {
		...
		if (has_fabric) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.LIGHT_GRAY_DYE)) : false) {
				slot = 0;
				for (int index1 = 0; index1 < 36; index1++) {
					...
					}.getItemStack((int) slot, entity)).getItem() == Items.LIGHT_GRAY_DYE) {
			...
			if (has_dye1) {
				if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.PURPLE_DYE)) : false) {
					slot = 0;
					for (int index2 = 0; index2 < 36; index2++) {
						...
						}.getItemStack((int) slot, entity)).getItem() == Items.PURPLE_DYE) {
				...
				if (has_dye2) {
					...
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.DUPLI_KATE_SUIT_CHESTPLATE.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.DUPLI_KATE_SUIT_LEGGINGS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.DUPLI_KATE_SUIT_BOOTS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
					...
					if (entity instanceof Player _player)
						_player.closeContainer();
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Purple Dye."), false);
				}
			} else {
				if (entity instanceof Player _player)
					_player.closeContainer();
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Light Gray Dye"), false);
			}
		} else {
			if (entity instanceof Player _player)
				_player.closeContainer();
