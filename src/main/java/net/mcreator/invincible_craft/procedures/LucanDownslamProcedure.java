...
public class LucanDownslamProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).hurt(
				...
				(float) ((entity instanceof LivingEntity _livingEntity20 && _livingEntity20.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity20.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) * 0.875));
		knockbackres = Math.min(1,
				Math.max((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) instanceof LivingEntity _livingEntity25 && _livingEntity25.getAttributes().hasAttribute(Attributes.KNOCKBACK_RESISTANCE)
						...
						: 0, 0));
		(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).setDeltaMovement(new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDeltaMovement().x()), ((-3) * (1 - knockbackres / 1)),
				((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDeltaMovement().z())));
