...
public class BanditEventHandlerProcedure {
	@SubscribeEvent
				...
				if (random_event == 1) {
					...
					if (!(CordY <= -50)) {
						if (!world.isClientSide() && world.getServer() != null)
							world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A7l\u00A74 A group of bandits has been spotted at " + new java.text.DecimalFormat("##").format(CordX) + " "
