...
public class ThraggSonicClapProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity target) {
		...
		if ((entity instanceof ThraggExiledEntity _datEntI ? _datEntI.getEntityData().get(ThraggExiledEntity.DATA_AttackDuration) : 0) == 1) {
			if (entity instanceof ThraggExiledEntity) {
				((ThraggExiledEntity) entity).setAnimation("sonic_clap");
			}
		} else if ((entity instanceof ThraggExiledEntity _datEntI ? _datEntI.getEntityData().get(ThraggExiledEntity.DATA_AttackDuration) : 0) == 9) {
		...
		} else if ((entity instanceof ThraggExiledEntity _datEntI ? _datEntI.getEntityData().get(ThraggExiledEntity.DATA_AttackDuration) : 0) >= 15) {
