...
public class ArtRosenbaumCraftInvincibleSuitMohawkProcedure {
	public static void execute(Entity entity) {
		...
		if (has_fabric) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.GRAY_DYE)) : false) {
				slot = 0;
				for (int index1 = 0; index1 < 36; index1++) {
					...
					}.getItemStack((int) slot, entity)).getItem() == Items.GRAY_DYE) {
			...
			if (has_dye1) {
				if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.CYAN_DYE)) : false) {
					slot = 0;
					for (int index2 = 0; index2 < 36; index2++) {
						...
						}.getItemStack((int) slot, entity)).getItem() == Items.CYAN_DYE) {
				...
				if (has_dye2) {
					...
					if (entity instanceof Player _player)
						_player.closeContainer();
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Cyan Dye."), false);
				}
			} else {
				if (entity instanceof Player _player)
					_player.closeContainer();
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Gray Dye"), false);
			}
		} else {
			if (entity instanceof Player _player)
				_player.closeContainer();
