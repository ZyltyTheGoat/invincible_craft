...
public class ArtRosenbaumCraftInvincibleSuitOmniMarkProcedure {
		...
		if (has_fabric) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.WHITE_DYE)) : false) {
				...
				for (int index1 = 0; index1 < 36; index1++) {
					...
					}.getItemStack((int) slot, entity)).getItem() == Items.WHITE_DYE) {
			...
			if (has_dye1) {
				if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.RED_DYE)) : false) {
					...
					for (int index2 = 0; index2 < 36; index2++) {
						...
						}.getItemStack((int) slot, entity)).getItem() == Items.RED_DYE) {
				...
				if (has_dye2) {
					...
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.INVINCIBLE_SUIT_OMNI_MARK_HELMET.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.INVINCIBLE_SUIT_OMNI_MARK_CHESTPLATE.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.INVINCIBLE_SUIT_OMNI_MARK_LEGGINGS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.INVINCIBLE_SUIT_OMNI_MARK_BOOTS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
					...
					if (entity instanceof Player _player)
						_player.closeContainer();
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Red Dye."), false);
				}
			} else {
				if (entity instanceof Player _player)
					_player.closeContainer();
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some White Dye"), false);
			}
		} else {
			if (entity instanceof Player _player)
				_player.closeContainer();
