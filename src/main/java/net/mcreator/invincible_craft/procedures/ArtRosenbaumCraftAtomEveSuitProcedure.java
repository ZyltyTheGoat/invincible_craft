...
public class ArtRosenbaumCraftAtomEveSuitProcedure {
	public static void execute(Entity entity) {
		...
		if (has_fabric) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.PINK_DYE)) : false) {
				slot = 0;
				for (int index1 = 0; index1 < 36; index1++) {
					...
					}.getItemStack((int) slot, entity)).getItem() == Items.PINK_DYE) {
			...
			if (has_dye1) {
				if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.MAGENTA_DYE)) : false) {
					slot = 0;
					for (int index2 = 0; index2 < 36; index2++) {
						...
						}.getItemStack((int) slot, entity)).getItem() == Items.MAGENTA_DYE) {
				...
				if (has_dye2) {
					...
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.ATOM_EVE_SUIT_CHESTPLATE.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.ATOM_EVE_SUIT_LEGGINGS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
						ItemStack _setstack = new ItemStack(InvincibleCraftModItems.ATOM_EVE_SUIT_BOOTS.get()).copy();
						_setstack.setCount(1);
						ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
					}
					if (entity instanceof Player _player) {
					...
					if (entity instanceof Player _player)
						_player.closeContainer();
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Magenta Dye."), false);
				}
			} else {
				if (entity instanceof Player _player)
					_player.closeContainer();
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Art the Suit Guy: You are missing some Pink Dye"), false);
			}
		} else {
			if (entity instanceof Player _player)
				_player.closeContainer();
