...
public class ConquestSonicClapProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity target) {
		...
		if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) == 1) {
			if (entity instanceof ConquestEntity) {
				((ConquestEntity) entity).setAnimation("sonic_clap");
			}
		} else if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) == 9) {
		...
		} else if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) >= 15) {
			if (entity instanceof ConquestEntity _datEntSetS)
				_datEntSetS.getEntityData().set(ConquestEntity.DATA_State, "IDLE");
			if (entity instanceof ConquestEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ConquestEntity.DATA_SonicClapCooldown, 250);
		}
	}
}
