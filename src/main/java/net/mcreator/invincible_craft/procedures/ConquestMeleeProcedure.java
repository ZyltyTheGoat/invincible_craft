...
public class ConquestMeleeProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity target) {
		...
		if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) == 1) {
			if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
				if (entity instanceof ConquestEntity) {
					((ConquestEntity) entity).setAnimation("punch_right");
				}
			} else {
				if (entity instanceof ConquestEntity) {
					((ConquestEntity) entity).setAnimation("punch_left");
				}
			}
		} else if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) == 2) {
		...
		} else if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) >= 6) {
			if (entity instanceof ConquestEntity _datEntSetS)
				_datEntSetS.getEntityData().set(ConquestEntity.DATA_State, "IDLE");
			if (entity instanceof ConquestEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ConquestEntity.DATA_MeleeCooldown, 15);
			{
				Entity _ent = entity;
