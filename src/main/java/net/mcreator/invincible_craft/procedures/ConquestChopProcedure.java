...
public class ConquestChopProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity target) {
		...
		if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) == 7) {
		...
		} else if ((entity instanceof ConquestEntity _datEntI ? _datEntI.getEntityData().get(ConquestEntity.DATA_AttackDuration) : 0) >= 10) {
			{
				Entity _ent = entity;
			...
			if (entity instanceof ConquestEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ConquestEntity.DATA_ChopCooldown, 300);
		}
	}
}
