...
public class TheGiantEntity extends Monster implements GeoEntity {
	...
	public TheGiantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InvincibleCraftModEntities.THE_GIANT.get(), world);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 30) {
			this.remove(TheGiantEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
