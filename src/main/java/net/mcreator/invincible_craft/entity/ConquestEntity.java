...
import net.mcreator.invincible_craft.procedures.ConquestOnEntityTickUpdateProcedure;
...
public class ConquestEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Boolean> DATA_Flying = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_State = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_SonicClapCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_DownslamCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_AttackDuration = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_GlobalAttackCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_UpslamCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_MeleeCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_ChopCooldown = SynchedEntityData.defineId(ConquestEntity.class, EntityDataSerializers.INT);
	...
	public ConquestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InvincibleCraftModEntities.CONQUEST.get(), world);
	}
	...
	public ConquestEntity(EntityType<ConquestEntity> type, Level world) {
		...
		setNoAi(false);
		setMaxUpStep(1.2f);
		setCustomName(Component.literal("Conquest"));
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "conquest");
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomStrollGoal(this, 15, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = ConquestEntity.this.getRandom();
				double dir_x = ConquestEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = ConquestEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = ConquestEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public void baseTick() {
		super.baseTick();
		ConquestOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
