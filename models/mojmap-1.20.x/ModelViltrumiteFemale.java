...
public class ModelViltrumiteFemale<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "viltrumitefemale"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = bone.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 16).mirror()
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(62, 21).addBox(0.0F, 2.0F, -2.0F, 1.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.8F, 1.7F, -0.2F, -0.4363F, 0.0F, 0.0F));

		PartDefinition Body_r2 = Body.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(62, 21).mirror()
						.addBox(-1.0F, 2.0F, -2.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition Body_r4 = Body.addOrReplaceChild("Body_r4", CubeListBuilder.create().texOffs(52, 48)
				.addBox(1.0F, 1.0F, -2.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.25F)).texOffs(52, 48).mirror()
				.addBox(-4.0F, 1.0F, -2.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.25F)).mirror(false).texOffs(18, 18)
				.mirror().addBox(-4.0F, 0.0F, -2.0F, 8.0F, 5.0F, 2.0F, new CubeDeformation(0.1F)).mirror(false),
		...
		PartDefinition LeftArm = bone.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(40, 16).mirror()
				.addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(40, 32)
				.mirror().addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false),
				PartPose.offset(5.0F, -22.0F, 0.0F));

		PartDefinition RightLeg = bone.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(16, 48).mirror()
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 48)
